...
class HTMLPurifierX_Strategy_RemoveForeignElements extends HTMLPurifier_Strategy_RemoveForeignElements
{
    ...
    public function execute($tokens, $config, $context)
    {
        ...
        $allowCustomElements = $config->get("HTML.AllowCustomElements");
        $allowCustomElementsRegex = $config->get("HTML.AllowCustomElementsRegex");
